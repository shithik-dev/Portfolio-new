...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y: contentY }}
        className="relative z-20 flex min-h-screen flex-col justify-between px-5 pb-8 pt-28 sm:px-8 sm:pb-10 sm:pt-32 lg:px-12 lg:pb-12 lg:pt-36"
      >
        {/* Top Information */}
          ...
          <div className="mt-10 grid gap-8 md:mt-14 md:grid-cols-[1fr_auto] md:items-end">
            ...
            >
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <a
                  href="#work"
                  className="group inline-flex items-center gap-3 bg-[#c7ff35] px-5 py-3 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-black transition-all duration-300 hover:bg-white"
                >
                  VIEW SELECTED WORK
                ...
                <a
                  href="#contact"
                  className="group inline-flex items-center gap-3 border border-white/25 bg-black/20 px-5 py-3 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-white backdrop-blur-sm transition-all duration-300 hover:border-white hover:bg-white hover:text-black"
                >
                  LET'S TALK
